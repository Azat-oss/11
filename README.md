...
### Мы команда профессионалов, объединённых общим делом — созданием качественного программного продукта!

- Разработчики (Backend & Frontend): отвечают за написание и оптимизацию кода.
- Дизайнер: занимается дизайном интерфейса и UX.
- QA Engineer: обеспечивает качество и стабильность нашего решения.
- PM: координирует работу всей команды, следит за сроками и выполнением задач.
